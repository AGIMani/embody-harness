...
IMAGE_TAG="${HARNESS_CAMERA_STREAMER_LITE_IMAGE:-harness-camera-streamer-lite:latest}"
BASE_TAG="${HARNESS_CAMERA_STREAMER_LITE_BASE_IMAGE:-harness-camera-streamer-lite:base}"
SKIP_DEPTHAI="true"
NO_CACHE="false"
...
Options:
  ...
  --image-tag TAG             Output image tag (default: harness-camera-streamer-lite:latest)
  --base-tag TAG              Temporary base tag (default: harness-camera-streamer-lite:base)
...
BUILD_CONTAINER="harness-camera-streamer-lite-build"
HOST_BUILD_DIR="$CAMERA_STREAMER_ROOT/build/harness_lite"
